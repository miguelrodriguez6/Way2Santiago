...
class StageController extends Controller
{
    ...
    public function index(): \Illuminate\Http\JsonResponse
    {
        ...
        $stages = Stage::with(['user', 'startLocation', 'endLocation', 'stageComments', 'stageParticipants'])->get();
    ...
    public function store(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $stage->load(['user', 'startLocation', 'endLocation', 'stageComments', 'stageParticipants']);
    ...
    public function show($id): \Illuminate\Http\JsonResponse
    {
        ...
        $stage = Stage::with(['user', 'startLocation', 'endLocation', 'stageComments', 'stageParticipants'])->find($id);
